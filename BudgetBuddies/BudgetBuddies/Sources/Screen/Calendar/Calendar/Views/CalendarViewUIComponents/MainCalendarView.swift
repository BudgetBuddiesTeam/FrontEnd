...
class MainCalendarView: UIView {
    ...
    var raisedInfoModels: [RaisedInfoModel] = [
        ...
        RaisedInfoModel(title: "어쩔거야", startDate: "2024-07-17", endDate: "2024-07-24", infoType: .discount),
        RaisedInfoModel(title: "안녕하세요", startDate: "2024-07-23", endDate: "2024-07-31", infoType: .support),
    ]
