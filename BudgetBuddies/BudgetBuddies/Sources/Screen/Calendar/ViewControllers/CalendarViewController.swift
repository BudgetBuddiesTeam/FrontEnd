...
final class CalendarViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.view.backgroundColor = #colorLiteral(red: 0.97647053, green: 0.97647053, blue: 0.97647053, alpha: 1)
...
extension CalendarViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == 0 { // 상단 이미지 셀
            let calendarImageCell = tableView.dequeueReusableCell(withIdentifier: "CalendarImageCell", for: indexPath) as! CalendarImageCell
            return calendarImageCell
            
        } else if indexPath.row == 1 { // 메인 캘린더 셀
            let mainCalendarCell = tableView.dequeueReusableCell(withIdentifier: "MainCalendarCell", for: indexPath) as! MainCalendarCell
            ...
            let infoTitleCell = tableView.dequeueReusableCell(withIdentifier: "InfoTitleCell", for: indexPath) as! InfoTitleCell
            ...
            let informationCell = tableView.dequeueReusableCell(withIdentifier: "InfomationCell", for: indexPath) as! InformationCell
