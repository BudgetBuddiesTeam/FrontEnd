...
final class DetailViewController: UIViewController {
    ...
    private func setupNavigationBar() {
        ...
        navigationController?.navigationBar.backgroundColor = #colorLiteral(red: 0.97647053, green: 0.97647053, blue: 0.97647053, alpha: 1)
        ...
        lazy var backButton: UIBarButtonItem = {
            let btn = UIBarButtonItem(image: UIImage(named: "backButtonImage")?.withRenderingMode(.alwaysOriginal),
                                      style: .done,
                                      target: self,
