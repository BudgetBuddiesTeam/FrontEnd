...
extension MonthPickerViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "MonthPickerCell", for: indexPath) as! MonthPickerCell
...
extension MonthPickerViewController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let unSelectedLabelColor = #colorLiteral(red: 0.4627450705, green: 0.4627450705, blue: 0.4627450705, alpha: 1)
