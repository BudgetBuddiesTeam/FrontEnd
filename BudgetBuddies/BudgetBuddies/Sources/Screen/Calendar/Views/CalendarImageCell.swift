...
class CalendarImageCell: UITableViewCell {
    ...
    private let yellowBackView: UIView = {
        ...
        view.layer.borderColor = #colorLiteral(red: 0.9984216094, green: 0.7218663096, blue: 0.01596412808, alpha: 1)
...
//        lb.font = UIFont.systemFont(ofSize: 12, weight: .semibold)
        ...
        lb.textColor = #colorLiteral(red: 0.5812363625, green: 0.4784846902, blue: 0.272742033, alpha: 1)
        return lb
    }()
