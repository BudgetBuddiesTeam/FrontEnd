...
class AllServiceContainerView: UIView {
  ...
  private let pocketCalendarIcon: UIImageView = {
    ...
    imageView.image =
      BudgetBuddiesAppAsset.AppImage.IconForAllLookingView.AllServiceContainer.todayCalendar.image
    return imageView
  }()
  ...
  private let priceEventInfoConfirmIcon: UIImageView = {
    let imageView = UIImageView()
    imageView.image =
      BudgetBuddiesAppAsset.AppImage.IconForAllLookingView.AllServiceContainer.lightning.image
    return imageView
  }()
