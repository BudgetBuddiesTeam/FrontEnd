...
class PhoneNumberChangeViewController: UIViewController {
  ...
  private func setupButtonActions() {
    self.phoneNumberChangeView.sendAuthNumberButton.addTarget(
      self, action: #selector(didTapSendAuthNumberButton), for: .touchUpInside)
    self.phoneNumberChangeView.completeAuthButton.addTarget(
      self, action: #selector(didTapCompleteAuthButton), for: .touchUpInside)
  }
