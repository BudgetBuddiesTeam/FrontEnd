...
class AddtionInfoViewController: UIViewController {
  ...
  var isRegionPicked: Bool = false {
    didSet {
      addtionInfoView.continueButtonToggle(
  ...
  private func setupButtonActions() {
    // 거주지역 선택 tapGesture
    addtionInfoView.regionPickerView.addGestureRecognizer(
    ...
    // 저장하기 버튼
    addtionInfoView.saveButton.addTarget(
      self, action: #selector(didTapSaveButton), for: .touchUpInside)
