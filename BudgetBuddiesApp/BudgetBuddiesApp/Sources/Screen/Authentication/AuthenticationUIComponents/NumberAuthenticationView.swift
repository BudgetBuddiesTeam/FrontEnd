...
class NumberAuthenticationView: UIView {
  ...
  private func setupUI() {
    ...
    case .join:
      self.addSubviews(
        stepDot, titleStackView, numberLabel, textFieldStackView, problemLabel, completeAuthButton)
      setupStepDotConstraints()
    case .login:
      self.addSubviews(
        titleStackView, numberLabel, textFieldStackView, problemLabel, completeAuthButton)
    }
