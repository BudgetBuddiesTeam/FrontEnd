...
final class BottomSheetViewController: DimmedViewController {
  ...
  private func modifyCancled() {
    if self.nowModify {
      ...
      self.bottomSheet.commentTextView.textColor = BudgetBuddiesAppAsset.AppColor.textExample.color
  ...
  func didTapSendButton() {
    ...
    // 플레이스홀더 재배치
    bottomSheet.commentTextView.text = textViewPrompt
    bottomSheet.commentTextView.textColor = BudgetBuddiesAppAsset.AppColor.textExample.color
...
extension BottomSheetViewController: UITextViewDelegate {
  ...
  func textViewDidBeginEditing(_ textView: UITextView) {
    if bottomSheet.commentTextView.textColor == BudgetBuddiesAppAsset.AppColor.textExample.color {
      bottomSheet.commentTextView.text = ""
      bottomSheet.commentTextView.textColor = BudgetBuddiesAppAsset.AppColor.textBlack.color
    }
  }
