...
class BannerView: UIView {
  ...
  var backView: UIView = {
    ...
    view.layer.borderColor = BudgetBuddiesAppAsset.AppColor.logoLine1.color.cgColor
  ...
  var fillPoketLabel: UILabel = {
    let lb = UILabel()
    lb.text = "주머니 채우는"
    lb.font = BudgetBuddiesAppFontFamily.Pretendard.semiBold.font(size: 12)
  ...
  var poketCalendarLabel: UILabel = {
    ...
    lb.font = BudgetBuddiesAppFontFamily.Pretendard.semiBold.font(size: 18)
