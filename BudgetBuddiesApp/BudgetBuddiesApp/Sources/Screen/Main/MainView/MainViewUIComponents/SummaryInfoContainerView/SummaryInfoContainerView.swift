...
final class SummaryInfoContainerView: UIView {
  ...
  private let monthRoundedRectangle: UIView = {
    let view = UIView()
    view.backgroundColor = BudgetBuddiesAppAsset.AppColor.lemon2.color
    view.layer.borderWidth = 1.5
    view.layer.borderColor = BudgetBuddiesAppAsset.AppColor.lemon.color.cgColor
  ...
  private let monthText: UILabel = {
    ...
    label.textColor = BudgetBuddiesAppAsset.AppColor.orange2.color
    return label
  }()
  ...
  private let commentBoxImageView: UIImageView = {
    ...
    imageView.image = BudgetBuddiesAppAsset.AppImage.MainViewImage.commentBox.image
  ...
  lazy var firstSecondLeftMoneyStackView: UIStackView = {
    let sv = UIStackView(arrangedSubviews: [
      firstCategoryLeftMoneyContainer, secondCategoryLeftMoneyContainer,
    ])
    sv.axis = .horizontal
  ...
  lazy var thirdFourthLeftMoneyStackView: UIStackView = {
    let sv = UIStackView(arrangedSubviews: [
      thirdCategoryLeftMoneyContainer, fourthCategoryLeftMoneyContainer,
    ])
    sv.axis = .horizontal
    sv.distribution = .fillEqually
    sv.alignment = .center
  ...
  private let divider: UIView = {
    let view = UIView()
    view.backgroundColor = BudgetBuddiesAppAsset.AppColor.strokeGray1.color
    return view
  }()
