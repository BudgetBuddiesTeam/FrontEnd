...
final class ReportTableViewCell: UITableViewCell {
  ...
  let descriptionLabel = {
    ...
    label.textColor = BudgetBuddiesAppAsset.AppColor.textBlack.color
    label.font = BudgetBuddiesAppFontFamily.Pretendard.medium.font(size: 14)
    label.backgroundColor = BudgetBuddiesAppAsset.AppColor.textBox.color
  ...
  func configure(with report: ReportModel) {
    ...
    attributedText.addAttribute(
      .foregroundColor, value: BudgetBuddiesAppAsset.AppColor.logoLine2.color, range: range)  // Set your desired color
