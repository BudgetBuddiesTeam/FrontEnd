...
final class AnalysisReportViewController: UIViewController {
  ...
  let titleLabel = {
    ...
    label.font = BudgetBuddiesAppFontFamily.Pretendard.semiBold.font(size: 24)
  ...
  lazy var rangeEditButton = {
    ...
    button.setTitleColor(BudgetBuddiesAppAsset.AppColor.logoLine2.color, for: .normal)
    button.titleLabel?.font = BudgetBuddiesAppFontFamily.Pretendard.medium.font(size: 14)
    button.backgroundColor = BudgetBuddiesAppAsset.AppColor.lemon2.color
    button.layer.cornerRadius = 10
    button.layer.borderWidth = 1
    button.layer.borderColor = BudgetBuddiesAppAsset.AppColor.lemon.color.cgColor
  ...
  private func setupChart(_ topGoals: [GetTopGoalsResponse.GetTopGoalsResult]) {
    // 차트에 사용할 색상 배열
    let colors: [UIColor] = [
      BudgetBuddiesAppAsset.AppColor.coreBlue.color,
      BudgetBuddiesAppAsset.AppColor.sky3.color,
      BudgetBuddiesAppAsset.AppColor.orange2.color,
  ...
  private func setupBarChart(
    ...
    // 차트에 사용할 색상 배열
    let colors: [UIColor] = [
      BudgetBuddiesAppAsset.AppColor.logoLine2.color,
      BudgetBuddiesAppAsset.AppColor.coreYellow.color,
      BudgetBuddiesAppAsset.AppColor.face.color,
    ]
