...
final class GoalReportViewController: UIViewController {
  ...
  var reports: [ReportModel] = [
    ReportModel(
      categoryImage: BudgetBuddiesAppAsset.AppImage.CategoryIcon.foodIcon2.image, rank: "1",
      title: "식비", amount: "123,180",
      description: "50,000"),
    ReportModel(
      categoryImage: BudgetBuddiesAppAsset.AppImage.CategoryIcon.shoppingIcon2.image, rank: "2",
      title: "식비", amount: "123,180",
      description: "50,000"),
    ReportModel(
      categoryImage: BudgetBuddiesAppAsset.AppImage.CategoryIcon.fashionIcon2.image, rank: "3",
      title: "식비", amount: "123,180",
      description: "50,000"),
    ReportModel(
      categoryImage: BudgetBuddiesAppAsset.AppImage.CategoryIcon.cultureIcon2.image, rank: "4",
      title: "식비", amount: "123,180",
      description: "50,000"),
    ReportModel(
      categoryImage: BudgetBuddiesAppAsset.AppImage.CategoryIcon.trafficIcon2.image, rank: "5",
      title: "식비", amount: "123,180",
      description: "50,000"),
  ]
  ...
  private func setNavigationSetting() {
    ...
    self.setupDefaultNavigationBar(backgroundColor: BudgetBuddiesAppAsset.AppColor.background.color)
  ...
  private func setTableView() {
    ...
    tableView.backgroundColor = BudgetBuddiesAppAsset.AppColor.background.color
  }
  ...
  private func updateReports(with goals: [GetTopGoalResponse.GetTopGoalResult]) {
    ...
    self.reports = sortedGoals.enumerated().compactMap { (index, goal) in
      ...
      let image = BudgetBuddiesAppAsset.AppImage.CategoryIcon.getImageForCategory(categoryName)
  ...
  private func updateMainLabel(with categoryName: String) {
    ...
    attributedText.addAttribute(
      .foregroundColor, value: BudgetBuddiesAppAsset.AppColor.logoLine2.color, range: range)
...
extension BudgetBuddiesAppAsset.AppImage.CategoryIcon {
